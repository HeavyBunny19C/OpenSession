...
oh-my-opensession reads your OpenCode SQLite database in **read-only mode** to display sessions. Management metadata (stars, renames, soft deletes) is stored in a separate `meta.db`:
